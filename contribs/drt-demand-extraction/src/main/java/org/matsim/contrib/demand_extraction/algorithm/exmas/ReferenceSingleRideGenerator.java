 ...
 */
public final class ReferenceSingleRideGenerator {
	private static final Logger log = LogManager.getLogger(ReferenceSingleRideGenerator.class);

	private final MatsimNetworkCache networkCache;
	private final BudgetValidator budgetValidator;

	public ReferenceSingleRideGenerator(MatsimNetworkCache networkCache, BudgetValidator budgetValidator) {
