 ...
 * </ul>
 *
 * <p>The Phase-1 request pre-filter that used to run here (behind {@code --filter-study-yaml})
 * was removed 2026-08-19 (spec D4 / D5.1): it moves to Python as a stage between the two
 * Java phases, owned by {@code pipeline/runner.py} (Phase 5), rather than a CLI-driven
 * subprocess call into a Python script.
 *
 * <pre>
 ...
 *                --exmas-config ../../../outputs/lyon-twophase-1pct/exmas-config.xml \
...
public final class RunDemandExtractionTwoPhase {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		log.info("  exmas config:  {}", p.exmasConfig);
		log.info("======================================================================");
